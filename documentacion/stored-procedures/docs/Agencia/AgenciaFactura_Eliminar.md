...
# `euroamer_admin_2008.AgenciaFactura_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.AgenciaFactura_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-05-20 05:12:38` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaFactura_Eliminar.sql` |
