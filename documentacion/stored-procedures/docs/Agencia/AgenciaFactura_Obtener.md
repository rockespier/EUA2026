...
# `euroamer_admin_2008.AgenciaFactura_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.AgenciaFactura_Obtener` |
...
| `modify_date` en BD al extraer | `2025-05-20 05:22:10` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaFactura_Obtener.sql` |
