...
# `euroamer_admin_2008.AgenciaFactura_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.AgenciaFactura_Procesar` |
...
| `modify_date` en BD al extraer | `2025-05-20 07:36:38` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaFactura_Procesar.sql` |
