...
# `euroamer_admin_2008.AgenciaProducto_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.AgenciaProducto_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-07-03 07:24:31` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaProducto_Eliminar.sql` |
...
|---|---|---|---|
| _(no se detectaron automáticamente — revisar el .sql a mano)_ | | | |
