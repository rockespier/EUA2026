...
# `euroamer_admin_2008.AgenciaProducto_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.AgenciaProducto_Procesar` |
...
| `modify_date` en BD al extraer | `2025-07-03 07:22:38` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaProducto_Procesar.sql` |
