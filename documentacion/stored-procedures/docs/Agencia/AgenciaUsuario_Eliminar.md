...
# `euroamer_admin_2008.AgenciaUsuario_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.AgenciaUsuario_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-01-02 06:23:40` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaUsuario_Eliminar.sql` |
