...
# `euroamer_admin_2008.AgenciaUsuario_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.AgenciaUsuario_Obtener` |
...
| `modify_date` en BD al extraer | `2025-02-14 03:51:53` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaUsuario_Obtener.sql` |
