...
# `euroamer_admin_2008.AgenciaVenta_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.AgenciaVenta_Obtener` |
...
| `modify_date` en BD al extraer | `2024-07-27 14:42:06` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaVenta_Obtener.sql` |
