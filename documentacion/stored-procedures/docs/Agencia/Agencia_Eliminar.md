...
# `euroamer_admin_2008.Agencia_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.Agencia_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-01-02 06:23:39` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Agencia_Eliminar.sql` |
