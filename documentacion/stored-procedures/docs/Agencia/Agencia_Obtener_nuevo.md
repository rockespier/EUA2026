...
# `euroamer_admin_2008.Agencia_Obtener_nuevo`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.Agencia_Obtener` |
...
| `modify_date` en BD al extraer | `2026-08-11 06:54:55` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Agencia_Obtener_nuevo.sql` |
...
| `PERFIL` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `Ubigeo` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
