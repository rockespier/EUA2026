...
# `euroamer_admin_2008.Agencia_Procesar_nuevo`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.Agencia_Procesar` |
...
| `modify_date` en BD al extraer | `2026-08-19 07:47:19` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Agencia_Procesar_nuevo.sql` |
