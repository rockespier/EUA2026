...
# `euroamer_admin_2008.Comision_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.Venta_ObtenerComision` |
...
| `modify_date` en BD al extraer | `2025-07-14 02:13:40` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Comision_Obtener.sql` |
