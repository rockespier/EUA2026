...
# `euroamer_admin_2008.UsuarioPromotor_ValidarExistencia`

| Campo | Valor |
|---|---|
| Dominio | `Agencia` |
| Repositorio (.NET) | `AgenciaRepository.cs` |
| Método(s) que lo invoca | `AgenciaRepository.AgenciaPromotor_Validar` |
...
| `modify_date` en BD al extraer | `2017-03-13 16:42:59` |
| Archivo fuente | `../../sql/euroamer_admin_2008.UsuarioPromotor_ValidarExistencia.sql` |
