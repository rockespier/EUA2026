...
# `euroamer_admin_2008.Cobranza_Actualizar`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.Cobranza_Actualizar` |
...
| `modify_date` en BD al extraer | `2026-02-11 01:46:06` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cobranza_Actualizar.sql` |
