...
# `euroamer_admin_2008.Cobranza_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.Cobranza_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-08-08 03:48:46` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cobranza_Eliminar.sql` |
