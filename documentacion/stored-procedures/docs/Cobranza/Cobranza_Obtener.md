...
# `euroamer_admin_2008.Cobranza_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.Cobranza_Obtener` |
...
| `modify_date` en BD al extraer | `2025-08-07 07:24:10` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cobranza_Obtener.sql` |
