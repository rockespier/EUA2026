...
# `euroamer_admin_2008.Cobranza_PagoEliminar`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.CobranzaPago_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-03-19 11:26:11` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cobranza_PagoEliminar.sql` |
