...
# `euroamer_admin_2008.Cobranza_PagoObtener`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.CobranzaPago_Obtener` |
...
| `modify_date` en BD al extraer | `2025-03-19 11:30:20` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cobranza_PagoObtener.sql` |
