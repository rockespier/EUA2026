...
# `euroamer_admin_2008.Cobranza_PagoProcesar`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.CobranzaPago_Procesar` |
...
| `modify_date` en BD al extraer | `2025-03-19 11:28:45` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cobranza_PagoProcesar.sql` |
