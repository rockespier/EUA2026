...
# `euroamer_admin_2008.Cobranza_PagoVerificarObtener`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.CobranzaVerificarPago_Obtener` |
...
| `modify_date` en BD al extraer | `2025-07-18 08:39:56` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cobranza_PagoVerificarObtener.sql` |
...
| `euroamer_admin_2008.COBRANZA_PAGO` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
