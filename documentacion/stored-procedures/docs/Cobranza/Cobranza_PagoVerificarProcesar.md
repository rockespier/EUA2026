...
# `euroamer_admin_2008.Cobranza_PagoVerificarProcesar`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.CobranzaVerificarPago_Procesar` |
...
| `modify_date` en BD al extraer | `2025-07-09 07:58:33` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cobranza_PagoVerificarProcesar.sql` |
...
| `COBRANZA_PAGO` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
