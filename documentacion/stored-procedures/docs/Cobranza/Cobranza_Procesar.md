...
# `euroamer_admin_2008.Cobranza_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza, Pasajero` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.Cobranza_Procesar, PasajeroRepository.Pasajero_Procesar` |
...
| `modify_date` en BD al extraer | `2025-08-07 08:33:52` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cobranza_Procesar.sql` |
