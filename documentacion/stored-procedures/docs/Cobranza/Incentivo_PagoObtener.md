...
# `euroamer_admin_2008.Incentivo_PagoObtener`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.IncentivoPago_Obtener` |
...
| `modify_date` en BD al extraer | `2025-07-14 06:49:01` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Incentivo_PagoObtener.sql` |
...
|---|---|---|---|
| `INCENTIVO_PAGO` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
