...
# `euroamer_admin_2008.Incentivo_PagoProcesar`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.IncentivoPago_Procesar` |
...
| `modify_date` en BD al extraer | `2025-04-17 05:03:48` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Incentivo_PagoProcesar.sql` |
...
|---|---|---|---|
| `euroamer_admin_2008.INCENTIVO_PAGO` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
