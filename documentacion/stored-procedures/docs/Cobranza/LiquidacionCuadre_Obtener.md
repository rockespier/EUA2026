...
# `euroamer_admin_2008.LiquidacionCuadre_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Cobranza` |
| Repositorio (.NET) | `CobranzaRepository.cs` |
| Método(s) que lo invoca | `CobranzaRepository.CobranzaReporte_Obtener` |
...
| `modify_date` en BD al extraer | `2025-10-27 06:06:32` |
| Archivo fuente | `../../sql/euroamer_admin_2008.LiquidacionCuadre_Obtener.sql` |
