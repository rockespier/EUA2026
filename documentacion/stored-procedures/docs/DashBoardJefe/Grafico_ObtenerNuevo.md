...
# `euroamer_admin_2008.Grafico_ObtenerNuevo`

| Campo | Valor |
|---|---|
| Dominio | `DashBoardJefe` |
| Repositorio (.NET) | `DashBoardJefeRepository.cs` |
| Método(s) que lo invoca | `DashBoardJefeRepository.DashBoard_GraficoObtener` |
...
| `modify_date` en BD al extraer | `2026-01-30 08:36:00` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Grafico_ObtenerNuevo.sql` |
