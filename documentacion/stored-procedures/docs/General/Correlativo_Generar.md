...
# `euroamer_admin_2008.Correlativo_Generar`

| Campo | Valor |
|---|---|
| Dominio | `General` |
| Repositorio (.NET) | `GeneralRepository.cs` |
| Método(s) que lo invoca | `GeneralRepository.Correlativo_Generar` |
...
| `modify_date` en BD al extraer | `2025-02-08 02:18:04` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Correlativo_Generar.sql` |
