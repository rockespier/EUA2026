...
# `euroamer_admin_2008.GenerarCodigoLiquidacion_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `General` |
| Repositorio (.NET) | `GeneralRepository.cs` |
| Método(s) que lo invoca | `GeneralRepository.CorrelativoLiquidacion_Obtener` |
...
| `modify_date` en BD al extraer | `2025-07-07 06:52:17` |
| Archivo fuente | `../../sql/euroamer_admin_2008.GenerarCodigoLiquidacion_Procesar.sql` |
