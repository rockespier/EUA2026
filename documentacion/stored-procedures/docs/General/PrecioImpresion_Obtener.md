...
# `euroamer_admin_2008.PrecioImpresion_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `General` |
| Repositorio (.NET) | `GeneralRepository.cs` |
| Método(s) que lo invoca | `GeneralRepository.PrecioImpresion_Obtener` |
...
| `modify_date` en BD al extraer | `2017-11-18 14:43:08` |
| Archivo fuente | `../../sql/euroamer_admin_2008.PrecioImpresion_Obtener.sql` |
