...
# `euroamer_admin_2008.Ubigeo_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `General` |
| Repositorio (.NET) | `GeneralRepository.cs` |
| Método(s) que lo invoca | `GeneralRepository.Ubigeo_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-01-02 06:23:44` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Ubigeo_Eliminar.sql` |
