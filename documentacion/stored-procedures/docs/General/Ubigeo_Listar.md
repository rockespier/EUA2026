...
# `euroamer_admin_2008.Ubigeo_Listar`

| Campo | Valor |
|---|---|
| Dominio | `General` |
| Repositorio (.NET) | `GeneralRepository.cs` |
| Método(s) que lo invoca | `GeneralRepository.Ubigeo_Listar` |
...
| `modify_date` en BD al extraer | `2025-04-29 08:32:30` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Ubigeo_Listar.sql` |
