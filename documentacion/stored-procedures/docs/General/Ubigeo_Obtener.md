...
# `euroamer_admin_2008.Ubigeo_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `General` |
| Repositorio (.NET) | `GeneralRepository.cs` |
| Método(s) que lo invoca | `GeneralRepository.Ubigeo_Obtener` |
...
| `modify_date` en BD al extraer | `2025-04-29 08:31:38` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Ubigeo_Obtener.sql` |
