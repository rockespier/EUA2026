...
# `euroamer_admin_2008.ValoresTipoId_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `General` |
| Repositorio (.NET) | `GeneralRepository.cs` |
| Método(s) que lo invoca | `GeneralRepository.ValoresTipoId_Obtener` |
...
| `modify_date` en BD al extraer | `2017-11-22 09:41:27` |
| Archivo fuente | `../../sql/euroamer_admin_2008.ValoresTipoId_Obtener.sql` |
