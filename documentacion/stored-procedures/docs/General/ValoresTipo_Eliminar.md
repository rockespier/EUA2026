...
# `euroamer_admin_2008.ValoresTipo_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `General` |
| Repositorio (.NET) | `GeneralRepository.cs` |
| Método(s) que lo invoca | `GeneralRepository.ValoresTipo_Eliminar` |
...
| `modify_date` en BD al extraer | `2024-12-30 02:49:13` |
| Archivo fuente | `../../sql/euroamer_admin_2008.ValoresTipo_Eliminar.sql` |
