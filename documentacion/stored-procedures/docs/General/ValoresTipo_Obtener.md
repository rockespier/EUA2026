...
# `euroamer_admin_2008.ValoresTipo_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `General` |
| Repositorio (.NET) | `GeneralRepository.cs` |
| Método(s) que lo invoca | `GeneralRepository.ValoresTipo_Obtener` |
...
| `modify_date` en BD al extraer | `2016-12-12 21:01:01` |
| Archivo fuente | `../../sql/euroamer_admin_2008.ValoresTipo_Obtener.sql` |
