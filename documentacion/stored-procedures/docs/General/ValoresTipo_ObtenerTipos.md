...
# `euroamer_admin_2008.ValoresTipo_ObtenerTipos`

| Campo | Valor |
|---|---|
| Dominio | `General` |
| Repositorio (.NET) | `GeneralRepository.cs` |
| Método(s) que lo invoca | `GeneralRepository.ValoresTipo_ObtenerTipos` |
...
| `modify_date` en BD al extraer | `2024-12-30 03:04:44` |
| Archivo fuente | `../../sql/euroamer_admin_2008.ValoresTipo_ObtenerTipos.sql` |
