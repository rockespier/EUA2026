...
# `euroamer_admin_2008.ValoresTipo_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `General` |
| Repositorio (.NET) | `GeneralRepository.cs` |
| Método(s) que lo invoca | `GeneralRepository.ValoresTipo_Procesar` |
...
| `modify_date` en BD al extraer | `2024-12-30 03:19:46` |
| Archivo fuente | `../../sql/euroamer_admin_2008.ValoresTipo_Procesar.sql` |
