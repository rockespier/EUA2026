...
# `euroamer_admin_2008.Grafico_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Grafico` |
| Repositorio (.NET) | `GraficoRepository.cs` |
| Método(s) que lo invoca | `GraficoRepository.Grafico_Pie` |
...
| `modify_date` en BD al extraer | `2024-11-18 06:08:24` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Grafico_Obtener.sql` |
