...
# `euroamer_admin_2008.Menu_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Menu` |
| Repositorio (.NET) | `MenuRepository.cs` |
| Método(s) que lo invoca | `MenuRepository.Menu_Obtener` |
...
| `modify_date` en BD al extraer | `2025-04-17 05:04:09` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Menu_Obtener.sql` |
