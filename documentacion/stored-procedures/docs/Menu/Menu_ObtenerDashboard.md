...
# `euroamer_admin_2008.Menu_ObtenerDashboard`

| Campo | Valor |
|---|---|
| Dominio | `Menu` |
| Repositorio (.NET) | `MenuRepository.cs` |
| Método(s) que lo invoca | `MenuRepository.MenuDashboard_Obtener` |
...
| `modify_date` en BD al extraer | `2025-10-09 03:57:24` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Menu_ObtenerDashboard.sql` |
