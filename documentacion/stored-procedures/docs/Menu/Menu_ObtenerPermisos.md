...
# `euroamer_admin_2008.Menu_ObtenerPermisos`

| Campo | Valor |
|---|---|
| Dominio | `Menu, Permiso` |
| Repositorio (.NET) | `MenuRepository.cs` |
| Método(s) que lo invoca | `MenuRepository.Menu_ObtenerPermisos, PermisoRepository.PermisoArbol_ObtenerPermisos` |
...
| `modify_date` en BD al extraer | `2025-01-08 06:03:08` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Menu_ObtenerPermisos.sql` |
...
|---|---|---|---|
| `MENU` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `PERFIL_MENU` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
