...
# `euroamer_admin_2008.Menu_ObtenerPermisosBotones`

| Campo | Valor |
|---|---|
| Dominio | `Menu` |
| Repositorio (.NET) | `MenuRepository.cs` |
| Método(s) que lo invoca | `MenuRepository.Menu_ObtenerPermisosBotones` |
...
| `modify_date` en BD al extraer | `2015-10-18 17:34:40` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Menu_ObtenerPermisosBotones.sql` |
