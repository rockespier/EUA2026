...
# `euroamer_admin_2008.Cotizador_OrigenDestino_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Pais` |
| Repositorio (.NET) | `PaisRepository.cs` |
| Método(s) que lo invoca | `PaisRepository.Pais_OrigenDestinoObtener` |
...
| `modify_date` en BD al extraer | `2025-10-06 08:15:02` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cotizador_OrigenDestino_Obtener.sql` |
