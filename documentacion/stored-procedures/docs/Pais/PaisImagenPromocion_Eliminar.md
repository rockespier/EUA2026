...
# `euroamer_admin_2008.PaisImagenPromocion_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Pais` |
| Repositorio (.NET) | `PaisRepository.cs` |
| Método(s) que lo invoca | `PaisRepository.PaisImagenPromocion_Eliminar` |
...
| Archivo fuente | `../../sql/euroamer_admin_2008.PaisImagenPromocion_Eliminar.sql` |
