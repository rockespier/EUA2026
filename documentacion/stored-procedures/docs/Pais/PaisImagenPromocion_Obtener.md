...
# `euroamer_admin_2008.PaisImagenPromocion_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Pais` |
| Repositorio (.NET) | `PaisRepository.cs` |
| Método(s) que lo invoca | `PaisRepository.PaisImagenPromocion_Obtener` |
...
| Archivo fuente | `../../sql/euroamer_admin_2008.PaisImagenPromocion_Obtener.sql` |
