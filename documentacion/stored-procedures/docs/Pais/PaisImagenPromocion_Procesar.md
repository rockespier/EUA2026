...
# `euroamer_admin_2008.PaisImagenPromocion_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Pais` |
| Repositorio (.NET) | `PaisRepository.cs` |
| Método(s) que lo invoca | `PaisRepository.PaisImagenPromocion_Procesar` |
...
| `modify_date` en BD al extraer | `2016-12-09 20:42:05` |
| Archivo fuente | `../../sql/euroamer_admin_2008.PaisImagenPromocion_Procesar.sql` |
...
|---|---|---|---|
| `PAIS_IMAGENPROMOCION` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
