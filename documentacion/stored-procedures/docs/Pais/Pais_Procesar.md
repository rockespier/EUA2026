...
# `euroamer_admin_2008.Pais_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Pais` |
| Repositorio (.NET) | `PaisRepository.cs` |
| Método(s) que lo invoca | `PaisRepository.Pais_Procesar` |
...
| `modify_date` en BD al extraer | `2025-01-19 05:06:51` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Pais_Procesar.sql` |
