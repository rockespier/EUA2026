...
# `euroamer_admin_2008.Pasajero_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Pasajero, Venta` |
| Repositorio (.NET) | `PasajeroRepository.cs` |
| Método(s) que lo invoca | `PasajeroRepository.Pasajero_Obtener, VentaRepository.Venta_ObtenerPasajero` |
...
| `modify_date` en BD al extraer | `2025-08-14 02:59:29` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Pasajero_Obtener.sql` |
...
|---|---|---|---|
| `PASAJERO` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
