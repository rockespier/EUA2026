...
# `euroamer_admin_2008.PerfilMenu_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Perfil, Permiso` |
| Repositorio (.NET) | `PerfilRepository.cs` |
| Método(s) que lo invoca | `PerfilRepository.PerfilMenu_Procesar, PermisoRepository.PermisoArbol_Procesar` |
...
| `modify_date` en BD al extraer | `2025-01-17 09:30:49` |
| Archivo fuente | `../../sql/euroamer_admin_2008.PerfilMenu_Procesar.sql` |
