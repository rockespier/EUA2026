...
# `euroamer_admin_2008.Perfil_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Perfil` |
| Repositorio (.NET) | `PerfilRepository.cs` |
| Método(s) que lo invoca | `PerfilRepository.Perfil_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-01-02 06:23:41` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Perfil_Eliminar.sql` |
