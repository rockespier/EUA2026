...
# `euroamer_admin_2008.Perfil_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Perfil` |
| Repositorio (.NET) | `PerfilRepository.cs` |
| Método(s) que lo invoca | `PerfilRepository.Perfil_Obtener` |
...
| `modify_date` en BD al extraer | `2025-02-05 01:59:58` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Perfil_Obtener.sql` |
