...
# `euroamer_admin_2008.Perfil_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Perfil` |
| Repositorio (.NET) | `PerfilRepository.cs` |
| Método(s) que lo invoca | `PerfilRepository.Perfil_Procesar` |
...
| `modify_date` en BD al extraer | `2025-01-17 22:42:30` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Perfil_Procesar.sql` |
