...
# `euroamer_admin_2008.Cotizador_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.Cotizacion_Obtener` |
...
| `modify_date` en BD al extraer | `2025-10-23 08:31:31` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cotizador_Obtener.sql` |
...
| `producto_destino` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
