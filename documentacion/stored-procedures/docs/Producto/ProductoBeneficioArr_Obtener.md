...
# `euroamer_admin_2008.ProductoBeneficioArr_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.ProductoBeneficioCoti_Obtener` |
...
| `modify_date` en BD al extraer | `2025-10-24 02:26:17` |
| Archivo fuente | `../../sql/euroamer_admin_2008.ProductoBeneficioArr_Obtener.sql` |
...
|---|---|---|---|
| `cur_Cobertura` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `cur_prods` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `producto` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `PRODUCTO_BENEFICIO` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
