...
# `euroamer_admin_2008.ProductoBeneficio_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.ProductoBeneficio_Obtener` |
...
| `modify_date` en BD al extraer | `2025-01-25 07:34:10` |
| Archivo fuente | `../../sql/euroamer_admin_2008.ProductoBeneficio_Obtener.sql` |
