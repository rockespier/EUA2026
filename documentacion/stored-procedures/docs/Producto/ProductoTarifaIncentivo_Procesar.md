...
# `euroamer_admin_2008.ProductoTarifaIncentivo_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.ProductoTarifaIncentivo_Procesar` |
...
| `modify_date` en BD al extraer | `2025-04-02 06:46:15` |
| Archivo fuente | `../../sql/euroamer_admin_2008.ProductoTarifaIncentivo_Procesar.sql` |
