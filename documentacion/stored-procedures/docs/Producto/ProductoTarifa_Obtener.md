...
# `euroamer_admin_2008.ProductoTarifa_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.ProductoTarifas_Obtener` |
...
| `modify_date` en BD al extraer | `2025-01-29 09:37:03` |
| Archivo fuente | `../../sql/euroamer_admin_2008.ProductoTarifa_Obtener.sql` |
