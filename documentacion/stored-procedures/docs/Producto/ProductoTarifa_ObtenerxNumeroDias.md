...
# `euroamer_admin_2008.ProductoTarifa_ObtenerxNumeroDias`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.ProductoTarifa_ObtenerxNumeroDias` |
...
| Archivo fuente | `../../sql/euroamer_admin_2008.ProductoTarifa_ObtenerxNumeroDias.sql` |
