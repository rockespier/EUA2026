...
# `euroamer_admin_2008.ProductoTarifa_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.ProductoTarifa_Procesar` |
...
| `modify_date` en BD al extraer | `2025-04-02 06:12:43` |
| Archivo fuente | `../../sql/euroamer_admin_2008.ProductoTarifa_Procesar.sql` |
