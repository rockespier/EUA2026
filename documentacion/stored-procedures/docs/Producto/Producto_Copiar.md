...
# `euroamer_admin_2008.Producto_Copiar`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.Producto_Copiar` |
...
| `modify_date` en BD al extraer | `2025-12-24 06:46:28` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Producto_Copiar.sql` |
