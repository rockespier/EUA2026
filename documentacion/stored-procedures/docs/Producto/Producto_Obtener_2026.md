...
# `euroamer_admin_2008.Producto_Obtener_2026`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.Productos_Obtener` |
...
| `modify_date` en BD al extraer | `2026-08-20 08:14:25` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Producto_Obtener_2026.sql` |
