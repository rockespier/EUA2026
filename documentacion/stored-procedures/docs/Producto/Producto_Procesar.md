...
# `euroamer_admin_2008.Producto_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.Producto_Procesar` |
...
| `modify_date` en BD al extraer | `2025-12-24 06:49:06` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Producto_Procesar.sql` |
...
|---|---|---|---|
| `LogEventos` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
