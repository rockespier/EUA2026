...
# `euroamer_admin_2008.Producto_ValidaEquivalenvia`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.Producto_ValidaEquivalenvia` |
...
| `modify_date` en BD al extraer | `2016-12-29 15:50:05` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Producto_ValidaEquivalenvia.sql` |
