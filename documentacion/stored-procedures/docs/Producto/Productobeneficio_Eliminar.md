...
# `euroamer_admin_2008.Productobeneficio_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.ProductoBeneficio_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-01-02 06:23:42` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Productobeneficio_Eliminar.sql` |
