...
# `euroamer_admin_2008.Productobeneficio_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Producto` |
| Repositorio (.NET) | `ProductoRepository.cs` |
| Método(s) que lo invoca | `ProductoRepository.ProductoBeneficio_Procesar` |
...
| `modify_date` en BD al extraer | `2025-01-02 08:57:15` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Productobeneficio_Procesar.sql` |
