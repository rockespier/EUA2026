...
# `euroamer_admin_2008.PromocionPais_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Promocion` |
| Repositorio (.NET) | `PromocionRepository.cs` |
| Método(s) que lo invoca | `PromocionRepository.PromocionPais_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-04-14 02:42:51` |
| Archivo fuente | `../../sql/euroamer_admin_2008.PromocionPais_Eliminar.sql` |
