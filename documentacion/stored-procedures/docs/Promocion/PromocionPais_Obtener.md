...
# `euroamer_admin_2008.PromocionPais_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Promocion` |
| Repositorio (.NET) | `PromocionRepository.cs` |
| Método(s) que lo invoca | `PromocionRepository.PromocionPais_Obtener` |
...
| `modify_date` en BD al extraer | `2025-10-07 02:27:33` |
| Archivo fuente | `../../sql/euroamer_admin_2008.PromocionPais_Obtener.sql` |
