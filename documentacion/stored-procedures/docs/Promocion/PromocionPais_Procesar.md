...
# `euroamer_admin_2008.PromocionPais_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Promocion` |
| Repositorio (.NET) | `PromocionRepository.cs` |
| Método(s) que lo invoca | `PromocionRepository.PromocionPais_Procesar` |
...
| `modify_date` en BD al extraer | `2025-10-07 02:19:46` |
| Archivo fuente | `../../sql/euroamer_admin_2008.PromocionPais_Procesar.sql` |
