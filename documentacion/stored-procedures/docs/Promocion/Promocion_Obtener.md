...
# `euroamer_admin_2008.Promocion_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Promocion` |
| Repositorio (.NET) | `PromocionRepository.cs` |
| Método(s) que lo invoca | `PromocionRepository.Promocion_Obtener` |
...
| `modify_date` en BD al extraer | `2018-05-18 05:29:00` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Promocion_Obtener.sql` |
...
|---|---|---|---|
| `cursor_infor` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `euroamer_admin_2008.Split` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `pais` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `pais_promocion` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `PROMOCION` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
