...
# `euroamer_admin_2008.AgenciaCobranaza_Reporte`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.ResumenCobranzaReporte_Obtener` |
...
| `modify_date` en BD al extraer | `2025-07-08 05:44:34` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaCobranaza_Reporte.sql` |
