...
# `euroamer_admin_2008.AgenciaCobranza_Detalle`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.DetalleCobranzaReporte_Obtener` |
...
| `modify_date` en BD al extraer | `2025-07-08 05:39:58` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaCobranza_Detalle.sql` |
