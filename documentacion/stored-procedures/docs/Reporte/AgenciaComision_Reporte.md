...
# `euroamer_admin_2008.AgenciaComision_Reporte`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.ResumenComisionReporte_Obtener` |
...
| `modify_date` en BD al extraer | `2025-07-01 06:00:58` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaComision_Reporte.sql` |
...
|---|---|---|---|
| `AGENCIA_FACTURA` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
