...
# `euroamer_admin_2008.AgenciaDescuento_Reporte`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.ResumenDescuentoReporte_Obtener` |
...
| `modify_date` en BD al extraer | `2025-07-01 03:58:42` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaDescuento_Reporte.sql` |
