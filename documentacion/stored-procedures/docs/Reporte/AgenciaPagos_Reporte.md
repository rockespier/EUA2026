...
# `euroamer_admin_2008.AgenciaPagos_Reporte`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.ResumenPagoReporte_Obtener` |
...
| `modify_date` en BD al extraer | `2025-07-01 02:01:13` |
| Archivo fuente | `../../sql/euroamer_admin_2008.AgenciaPagos_Reporte.sql` |
