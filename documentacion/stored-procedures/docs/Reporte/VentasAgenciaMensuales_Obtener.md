...
# `euroamer_admin_2008.VentasAgenciaMensuales_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.VentasAgenciaMensuales_Obtener` |
...
| `modify_date` en BD al extraer | `2026-01-07 02:59:53` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentasAgenciaMensuales_Obtener.sql` |
