...
# `euroamer_admin_2008.VentasAgencia_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.VentasAgencia_Obtener` |
...
| `modify_date` en BD al extraer | `2025-10-01 03:15:24` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentasAgencia_Obtener.sql` |
