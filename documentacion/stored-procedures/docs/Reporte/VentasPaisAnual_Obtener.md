...
# `euroamer_admin_2008.VentasPaisAnual_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.VentasPaisAnual_Obtener` |
...
| `modify_date` en BD al extraer | `2026-02-26 08:36:45` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentasPaisAnual_Obtener.sql` |
