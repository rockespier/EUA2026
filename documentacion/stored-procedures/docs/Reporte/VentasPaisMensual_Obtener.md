...
# `euroamer_admin_2008.VentasPaisMensual_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.VentasPaisMensuales_Obtener` |
...
| `modify_date` en BD al extraer | `2025-12-31 07:04:52` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentasPaisMensual_Obtener.sql` |
