...
# `euroamer_admin_2008.VentasProductoMensuales_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.VentasProductoMensuales_Obtener` |
...
| `modify_date` en BD al extraer | `2025-03-27 08:28:17` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentasProductoMensuales_Obtener.sql` |
