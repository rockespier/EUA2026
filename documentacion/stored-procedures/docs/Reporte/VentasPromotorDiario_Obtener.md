...
# `euroamer_admin_2008.VentasPromotorDiario_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.VentasPromotorDiarias_Obtener` |
...
| `modify_date` en BD al extraer | `2025-10-28 03:01:08` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentasPromotorDiario_Obtener.sql` |
