...
# `euroamer_admin_2008.VentasPromotorMensuales_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.VentasPromotorMensuales_Obtener` |
...
| `modify_date` en BD al extraer | `2025-10-28 02:58:40` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentasPromotorMensuales_Obtener.sql` |
