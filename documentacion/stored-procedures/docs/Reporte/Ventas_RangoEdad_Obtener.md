...
# `euroamer_admin_2008.Ventas_RangoEdad_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Reporte` |
| Repositorio (.NET) | `ReporteRepository.cs` |
| Método(s) que lo invoca | `ReporteRepository.VentasRangoEdad_Obtener` |
...
| `modify_date` en BD al extraer | `2025-04-29 08:52:49` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Ventas_RangoEdad_Obtener.sql` |
...
| `VENTA_RANGO_EDAD` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
