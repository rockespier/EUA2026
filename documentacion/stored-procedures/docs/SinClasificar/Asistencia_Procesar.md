...
| `modify_date` en BD al extraer | `2015-03-25 09:52:03` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Asistencia_Procesar.sql` |
...
|---|---|---|---|
| `asistencia` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `empleado` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
