...
| `modify_date` en BD al extraer | `2018-04-17 21:04:36` |
| Archivo fuente | `../../sql/dbo.CommandExecute.sql` |
...
|---|---|---|---|---|
| `@Command` | `nvarchar` | IN | | |
| `@CommandType` | `nvarchar` | IN | | |
| `@Mode` | `int` | IN | | |
| `@Comment` | `nvarchar` | IN | | |
| `@DatabaseName` | `nvarchar` | IN | | |
| `@SchemaName` | `nvarchar` | IN | | |
| `@ObjectName` | `nvarchar` | IN | | |
| `@ObjectType` | `nvarchar` | IN | | |
| `@IndexName` | `nvarchar` | IN | | |
| `@IndexType` | `int` | IN | | |
| `@StatisticsName` | `nvarchar` | IN | | |
| `@PartitionNumber` | `int` | IN | | |
| `@ExtendedInfo` | `xml` | IN | | |
...
|---|---|---|---|
| `dbo.CommandLog` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
