...
| `modify_date` en BD al extraer | `2025-08-13 07:29:13` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Cotizador_ProductoCobertura_Consulta2.sql` |
...
|---|---|---|---|
| `cotizador_producto` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `cotizador_producto_cobertura` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `cotizador_producto_tarifa` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `cur_Bene` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `cur_Dscto` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `cur_Edad` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `cur_prods` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `cur_Select` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `euroamer_admin_2008.fnSplit2` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
