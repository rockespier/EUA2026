...
| `modify_date` en BD al extraer | `2026-08-19 03:16:49` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Opcion_Obtener.sql` |
...
|---|---|---|---|
| `opciones` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
