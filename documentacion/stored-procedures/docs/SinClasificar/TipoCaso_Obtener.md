...
| `modify_date` en BD al extraer | `2015-05-13 19:17:59` |
| Archivo fuente | `../../sql/euroamer_admin_2008.TipoCaso_Obtener.sql` |
...
|---|---|---|---|
| `caso` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `servicio` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
