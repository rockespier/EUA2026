...
| `modify_date` en BD al extraer | `2016-02-22 19:23:50` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VisitasApps_Agencias.sql` |
...
| `VISITAS` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `VISITAS_APPS` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
