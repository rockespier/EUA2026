...
| `modify_date` en BD al extraer | `2020-04-19 13:16:11` |
| Archivo fuente | `../../sql/euroamer_admin_2008.proc_ScriptIndexColumn.sql` |
...
|---|---|---|---|
| `index_cursor` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `sys.columns` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `sys.index_columns` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `sys.indexes` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `sysindexes` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `SYSOBJECTS` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
