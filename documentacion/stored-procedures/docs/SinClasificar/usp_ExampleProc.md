...
| `modify_date` en BD al extraer | `2023-05-04 10:47:12` |
| Archivo fuente | `../../sql/euroamer_admin_2008.usp_ExampleProc.sql` |
...
|---|---|---|---|
| `NonexistentTable` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
