...
# `euroamer_admin_2008.SolicitudMasiva_Atender`

| Campo | Valor |
|---|---|
| Dominio | `Solicitud` |
| Repositorio (.NET) | `SolicitudRepository.cs` |
| Método(s) que lo invoca | `SolicitudRepository.SolicitudMasiva_Atender` |
...
| `modify_date` en BD al extraer | `2025-11-04 00:30:38` |
| Archivo fuente | `../../sql/euroamer_admin_2008.SolicitudMasiva_Atender.sql` |
