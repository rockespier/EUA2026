...
# `euroamer_admin_2008.SolicitudMasiva_Rechazar`

| Campo | Valor |
|---|---|
| Dominio | `Solicitud` |
| Repositorio (.NET) | `SolicitudRepository.cs` |
| Método(s) que lo invoca | `SolicitudRepository.SolicitudMasvia_Rechazar` |
...
| `modify_date` en BD al extraer | `2025-02-26 09:11:56` |
| Archivo fuente | `../../sql/euroamer_admin_2008.SolicitudMasiva_Rechazar.sql` |
