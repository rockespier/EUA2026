...
# `euroamer_admin_2008.SolicitudTipo_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Solicitud` |
| Repositorio (.NET) | `SolicitudRepository.cs` |
| Método(s) que lo invoca | `SolicitudRepository.SolicitudTipo_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-01-02 06:23:43` |
| Archivo fuente | `../../sql/euroamer_admin_2008.SolicitudTipo_Eliminar.sql` |
...
|---|---|---|---|
| `SOLICITUD_TIPO` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
