...
# `euroamer_admin_2008.SolicitudTipo_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Solicitud` |
| Repositorio (.NET) | `SolicitudRepository.cs` |
| Método(s) que lo invoca | `SolicitudRepository.SolicitudTipo_Obtener` |
...
| `modify_date` en BD al extraer | `2025-04-29 05:43:25` |
| Archivo fuente | `../../sql/euroamer_admin_2008.SolicitudTipo_Obtener.sql` |
