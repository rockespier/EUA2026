...
# `euroamer_admin_2008.SolicitudTipo_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Solicitud` |
| Repositorio (.NET) | `SolicitudRepository.cs` |
| Método(s) que lo invoca | `SolicitudRepository.SolicitudTipo_Procesar` |
...
| `modify_date` en BD al extraer | `2025-01-02 08:57:16` |
| Archivo fuente | `../../sql/euroamer_admin_2008.SolicitudTipo_Procesar.sql` |
