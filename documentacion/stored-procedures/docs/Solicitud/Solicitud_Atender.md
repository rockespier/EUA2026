...
# `euroamer_admin_2008.Solicitud_Atender`

| Campo | Valor |
|---|---|
| Dominio | `Solicitud` |
| Repositorio (.NET) | `SolicitudRepository.cs` |
| Método(s) que lo invoca | `SolicitudRepository.Solicitud_Atender` |
...
| `modify_date` en BD al extraer | `2017-02-09 07:43:57` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Solicitud_Atender.sql` |
