...
# `euroamer_admin_2008.Solicitud_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Solicitud` |
| Repositorio (.NET) | `SolicitudRepository.cs` |
| Método(s) que lo invoca | `SolicitudRepository.Solicitud_Obtener` |
...
| `modify_date` en BD al extraer | `2026-04-22 06:32:20` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Solicitud_Obtener.sql` |
