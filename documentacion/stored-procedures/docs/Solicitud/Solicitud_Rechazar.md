...
# `euroamer_admin_2008.Solicitud_Rechazar`

| Campo | Valor |
|---|---|
| Dominio | `Solicitud` |
| Repositorio (.NET) | `SolicitudRepository.cs` |
| Método(s) que lo invoca | `SolicitudRepository.Solicitud_Rechazar` |
...
| Archivo fuente | `../../sql/euroamer_admin_2008.Solicitud_Rechazar.sql` |
