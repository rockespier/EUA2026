...
# `euroamer_admin_2008.GraficoReporte_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.GraficoPromotor_Obtener` |
...
| `modify_date` en BD al extraer | `2024-11-18 06:10:01` |
| Archivo fuente | `../../sql/euroamer_admin_2008.GraficoReporte_Obtener.sql` |
