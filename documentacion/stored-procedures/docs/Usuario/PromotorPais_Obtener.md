...
# `euroamer_admin_2008.PromotorPais_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.PromotorPais_Obtener` |
...
| `modify_date` en BD al extraer | `2025-08-14 08:01:30` |
| Archivo fuente | `../../sql/euroamer_admin_2008.PromotorPais_Obtener.sql` |
