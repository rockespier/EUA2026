...
# `euroamer_admin_2008.Promotor_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.PromotorJerarquia_Obtener` |
...
| Archivo fuente | `../../sql/euroamer_admin_2008.Promotor_Obtener.sql` |
