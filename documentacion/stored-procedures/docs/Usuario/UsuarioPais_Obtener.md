...
# `euroamer_admin_2008.UsuarioPais_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.UsuarioPais_Obtener` |
...
| Archivo fuente | `../../sql/euroamer_admin_2008.UsuarioPais_Obtener.sql` |
