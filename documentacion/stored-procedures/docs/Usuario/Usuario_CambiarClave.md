...
# `euroamer_admin_2008.Usuario_CambiarClave`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.Usuario_CambiarClave` |
...
| `modify_date` en BD al extraer | `2025-04-15 08:09:02` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_CambiarClave.sql` |
