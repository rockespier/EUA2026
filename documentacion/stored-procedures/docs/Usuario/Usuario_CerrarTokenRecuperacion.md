...
# `euroamer_admin_2008.Usuario_CerrarTokenRecuperacion`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.Usuario_CerrarTokenPassword` |
...
| `modify_date` en BD al extraer | `2025-04-15 08:12:31` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_CerrarTokenRecuperacion.sql` |
