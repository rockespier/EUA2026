...
# `euroamer_admin_2008.Usuario_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.Usuario_Obtener` |
...
| `modify_date` en BD al extraer | `2025-12-31 03:16:03` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_Obtener.sql` |
