...
# `euroamer_admin_2008.Usuario_ObtenerDatos`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.Usuario_ObtenerRecuperar` |
...
| `modify_date` en BD al extraer | `2014-01-28 20:00:47` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_ObtenerDatos.sql` |
