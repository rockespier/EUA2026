...
# `euroamer_admin_2008.Usuario_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.Usuario_Procesar` |
...
| `modify_date` en BD al extraer | `2025-09-01 07:49:18` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_Procesar.sql` |
