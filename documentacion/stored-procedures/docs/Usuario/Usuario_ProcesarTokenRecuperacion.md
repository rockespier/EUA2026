...
# `euroamer_admin_2008.Usuario_ProcesarTokenRecuperacion`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.Usuario_PrcesarTokenPassword` |
...
| `modify_date` en BD al extraer | `2025-04-15 08:08:30` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_ProcesarTokenRecuperacion.sql` |
...
| `USUARIO_RECUPERAR` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
