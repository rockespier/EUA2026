...
# `euroamer_admin_2008.Usuario_RelacionEliminar`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.SuperVisorPromotor_Eliminar` |
...
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_RelacionEliminar.sql` |
