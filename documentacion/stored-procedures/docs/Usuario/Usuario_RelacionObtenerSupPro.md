...
# `euroamer_admin_2008.Usuario_RelacionObtenerSupPro`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.Promotor_Obtener, UsuarioRepository.SuperVisor_Obtener` |
...
| `modify_date` en BD al extraer | `2025-01-02 08:57:17` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_RelacionObtenerSupPro.sql` |
