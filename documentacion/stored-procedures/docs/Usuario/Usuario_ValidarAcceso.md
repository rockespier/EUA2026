...
# `euroamer_admin_2008.Usuario_ValidarAcceso`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.Usuario_ValidarAcceso` |
...
| `modify_date` en BD al extraer | `2025-12-31 03:02:07` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_ValidarAcceso.sql` |
