...
# `euroamer_admin_2008.Usuario_ValidarExistencia`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.Usuario_ValidarExistencia` |
...
| `modify_date` en BD al extraer | `2025-04-15 08:08:45` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_ValidarExistencia.sql` |
