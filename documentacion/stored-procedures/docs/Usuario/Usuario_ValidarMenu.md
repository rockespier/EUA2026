...
# `euroamer_admin_2008.Usuario_ValidarMenu`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.Usuario_ValidarMenu` |
...
| `modify_date` en BD al extraer | `2025-03-21 10:38:52` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_ValidarMenu.sql` |
