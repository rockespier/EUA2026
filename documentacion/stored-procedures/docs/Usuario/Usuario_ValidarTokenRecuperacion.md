...
# `euroamer_admin_2008.Usuario_ValidarTokenRecuperacion`

| Campo | Valor |
|---|---|
| Dominio | `Usuario` |
| Repositorio (.NET) | `UsuarioRepository.cs` |
| Método(s) que lo invoca | `UsuarioRepository.Usuario_ValidarTokenRestablecerPassword` |
...
| `modify_date` en BD al extraer | `2025-04-15 08:11:12` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Usuario_ValidarTokenRecuperacion.sql` |
