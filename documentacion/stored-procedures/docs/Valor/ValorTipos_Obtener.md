...
# `euroamer_admin_2008.ValorTipos_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Valor` |
| Repositorio (.NET) | `ValorRepository.cs` |
| Método(s) que lo invoca | `ValorRepository.Valores_ObtenerTipos` |
...
| `modify_date` en BD al extraer | `2025-04-29 08:35:12` |
| Archivo fuente | `../../sql/euroamer_admin_2008.ValorTipos_Obtener.sql` |
