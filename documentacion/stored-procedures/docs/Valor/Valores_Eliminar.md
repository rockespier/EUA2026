...
# `euroamer_admin_2008.Valores_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Valor` |
| Repositorio (.NET) | `ValorRepository.cs` |
| Método(s) que lo invoca | `ValorRepository.Valores_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-01-17 07:55:52` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Valores_Eliminar.sql` |
