...
# `euroamer_admin_2008.Valores_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Valor` |
| Repositorio (.NET) | `ValorRepository.cs` |
| Método(s) que lo invoca | `ValorRepository.Valores_Obtener` |
...
| `modify_date` en BD al extraer | `2025-03-17 04:19:07` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Valores_Obtener.sql` |
