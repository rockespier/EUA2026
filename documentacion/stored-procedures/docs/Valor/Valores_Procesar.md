...
# `euroamer_admin_2008.Valores_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Valor` |
| Repositorio (.NET) | `ValorRepository.cs` |
| Método(s) que lo invoca | `ValorRepository.Valores_Procesar` |
...
| `modify_date` en BD al extraer | `2025-01-17 07:51:16` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Valores_Procesar.sql` |
