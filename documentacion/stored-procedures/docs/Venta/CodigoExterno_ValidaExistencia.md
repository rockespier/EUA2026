...
# `euroamer_admin_2008.CodigoExterno_ValidaExistencia`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaCodigoExterno_Validar` |
...
| `modify_date` en BD al extraer | `2025-04-07 08:46:28` |
| Archivo fuente | `../../sql/euroamer_admin_2008.CodigoExterno_ValidaExistencia.sql` |
