...
# `euroamer_admin_2008.Liquidacion_Obtener_2026`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Liquidacion_Obtener` |
...
| `modify_date` en BD al extraer | `2026-08-27 02:41:00` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Liquidacion_Obtener_2026.sql` |
