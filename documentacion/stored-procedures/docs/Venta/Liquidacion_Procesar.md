...
# `euroamer_admin_2008.Liquidacion_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Liquidacion_Procesar` |
...
| `modify_date` en BD al extraer | `2025-07-07 06:57:34` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Liquidacion_Procesar.sql` |
