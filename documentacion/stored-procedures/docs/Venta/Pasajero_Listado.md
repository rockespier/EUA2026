...
# `euroamer_admin_2008.Pasajero_Listado`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_ListaPasajero` |
...
| `modify_date` en BD al extraer | `2025-06-24 03:35:50` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Pasajero_Listado.sql` |
