...
# `euroamer_admin_2008.VentaCancelada_Detalle`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaObtenerVoucherCancelada` |
...
| `modify_date` en BD al extraer | `2025-09-08 08:06:29` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentaCancelada_Detalle.sql` |
