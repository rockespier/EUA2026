...
# `euroamer_admin_2008.VentaCliente_Eliminar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaCliente_Eliminar` |
...
| `modify_date` en BD al extraer | `2025-01-02 06:23:45` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentaCliente_Eliminar.sql` |
