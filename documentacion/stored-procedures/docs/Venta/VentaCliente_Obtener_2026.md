...
# `euroamer_admin_2008.VentaCliente_Obtener_2026`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaCliente_Obtener` |
...
| Archivo fuente | `../../sql/euroamer_admin_2008.VentaCliente_Obtener_2026.sql` |
