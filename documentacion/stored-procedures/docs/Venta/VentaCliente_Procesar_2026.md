...
# `euroamer_admin_2008.VentaCliente_Procesar_2026`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaCliente_Procesar` |
...
| `modify_date` en BD al extraer | `2026-08-31 08:22:22` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentaCliente_Procesar_2026.sql` |
