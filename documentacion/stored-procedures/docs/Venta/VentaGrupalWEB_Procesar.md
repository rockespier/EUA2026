...
# `euroamer_admin_2008.VentaGrupalWEB_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaGrupalWEB_Procesar` |
...
| `modify_date` en BD al extraer | `2024-08-12 10:09:59` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentaGrupalWEB_Procesar.sql` |
