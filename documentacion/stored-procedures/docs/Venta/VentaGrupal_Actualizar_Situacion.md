...
# `euroamer_admin_2008.VentaGrupal_Actualizar_Situacion`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_Grupal_Actualizar` |
...
| `modify_date` en BD al extraer | `2018-08-07 06:53:51` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentaGrupal_Actualizar_Situacion.sql` |
