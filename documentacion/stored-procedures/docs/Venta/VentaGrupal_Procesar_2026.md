...
# `euroamer_admin_2008.VentaGrupal_Procesar_2026`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaGrupal_Procesar` |
...
| `modify_date` en BD al extraer | `2026-09-07 01:04:01` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentaGrupal_Procesar_2026.sql` |
...
| `VENTA_CLIENTE` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
