...
# `euroamer_admin_2008.VentaGrupoSituacionWEB_Actualizar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaWEB_Situacion_Actualizar` |
...
| `modify_date` en BD al extraer | `2020-12-10 03:59:13` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentaGrupoSituacionWEB_Actualizar.sql` |
