...
# `euroamer_admin_2008.VentaPendiente_Detalle`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaObtenerVoucherPendiente` |
...
| `modify_date` en BD al extraer | `2018-07-12 09:19:10` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentaPendiente_Detalle.sql` |
