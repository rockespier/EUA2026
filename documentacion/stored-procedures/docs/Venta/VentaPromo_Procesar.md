...
# `euroamer_admin_2008.VentaPromo_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaPromo_Procesar` |
...
| `modify_date` en BD al extraer | `2017-03-25 18:41:08` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentaPromo_Procesar.sql` |
