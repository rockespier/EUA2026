...
# `euroamer_admin_2008.VentaSituacion_Actualizar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_Situacion_Actualizar` |
...
| `modify_date` en BD al extraer | `2018-07-13 07:13:25` |
| Archivo fuente | `../../sql/euroamer_admin_2008.VentaSituacion_Actualizar.sql` |
