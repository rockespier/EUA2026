...
# `euroamer_admin_2008.Venta_ActualizarGestionIncentivos`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaGestionIncentivos_Procesar` |
...
| `modify_date` en BD al extraer | `2026-08-26 04:47:39` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_ActualizarGestionIncentivos.sql` |
