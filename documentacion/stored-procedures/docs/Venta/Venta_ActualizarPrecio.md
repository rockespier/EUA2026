...
# `euroamer_admin_2008.Venta_ActualizarPrecio`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaPrecio_Procesar` |
...
| `modify_date` en BD al extraer | `2026-08-27 07:18:50` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_ActualizarPrecio.sql` |
