...
# `euroamer_admin_2008.Venta_ActualizarProcesar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.VentaActualizar_Procesar` |
...
| `modify_date` en BD al extraer | `2026-03-19 10:10:50` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_ActualizarProcesar.sql` |
