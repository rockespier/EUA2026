...
# `euroamer_admin_2008.Venta_Anular`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_Anular` |
...
| `modify_date` en BD al extraer | `2013-12-24 08:51:00` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_Anular.sql` |
