...
# `euroamer_admin_2008.Venta_CancelarExtornar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_CancelarExtornar` |
...
| `modify_date` en BD al extraer | `2025-08-11 01:21:35` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_CancelarExtornar.sql` |
