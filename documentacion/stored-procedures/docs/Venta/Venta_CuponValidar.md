...
# `euroamer_admin_2008.Venta_CuponValidar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_CuponValidar` |
...
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_CuponValidar.sql` |
...
| `VENTA_CUPON` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
