...
# `euroamer_admin_2008.Venta_Obtener`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_Web_Obtener` |
...
| `modify_date` en BD al extraer | `2026-04-13 04:40:56` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_Obtener.sql` |
