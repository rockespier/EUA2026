...
# `euroamer_admin_2008.Venta_ObtenerCliente`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_ObtenerCliente` |
...
| `modify_date` en BD al extraer | `2022-01-29 05:46:34` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_ObtenerCliente.sql` |
