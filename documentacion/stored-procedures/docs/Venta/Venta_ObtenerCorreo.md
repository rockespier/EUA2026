...
# `euroamer_admin_2008.Venta_ObtenerCorreo`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_ObtenerCorreo` |
...
| `modify_date` en BD al extraer | `2018-01-12 09:49:08` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_ObtenerCorreo.sql` |
