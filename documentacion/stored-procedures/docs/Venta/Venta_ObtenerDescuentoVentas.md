...
# `euroamer_admin_2008.Venta_ObtenerDescuentoVentas`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_ObtenerDescuentoVentas` |
...
| `modify_date` en BD al extraer | `2025-08-04 04:48:27` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_ObtenerDescuentoVentas.sql` |
