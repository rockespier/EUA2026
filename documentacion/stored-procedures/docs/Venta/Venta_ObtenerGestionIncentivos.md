...
# `euroamer_admin_2008.Venta_ObtenerGestionIncentivos`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_ObtenerGestionIncentivos` |
...
| `modify_date` en BD al extraer | `2026-08-26 04:06:55` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_ObtenerGestionIncentivos.sql` |
