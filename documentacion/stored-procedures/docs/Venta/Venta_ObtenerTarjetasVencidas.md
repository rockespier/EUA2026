...
# `euroamer_admin_2008.Venta_ObtenerTarjetasVencidas`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_ObtenerTarjetasVencidas` |
...
| `modify_date` en BD al extraer | `2015-05-28 11:00:12` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_ObtenerTarjetasVencidas.sql` |
