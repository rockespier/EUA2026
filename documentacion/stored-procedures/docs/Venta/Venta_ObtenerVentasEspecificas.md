...
# `euroamer_admin_2008.Venta_ObtenerVentasEspecificas`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_ObtenerVentasEspecificas` |
...
| `modify_date` en BD al extraer | `2026-02-06 07:15:06` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_ObtenerVentasEspecificas.sql` |
...
| `AGENCIA_PRODUCTO` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
