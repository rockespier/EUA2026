...
# `euroamer_admin_2008.Venta_Obtener_2026`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Ventas_Obtener` |
...
| `modify_date` en BD al extraer | `2026-09-07 00:41:10` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_Obtener_2026.sql` |
...
| `cobranza` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `cobranza_detalle` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `CobranzaUltima` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `PAIS` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `PRODUCTO` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `USUARIO` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `VALORES_TIPO` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `VENTA` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
| `VentasBase` | ? | ? | _(auto-detectado — verificar contra el .sql)_ |
