...
# `euroamer_admin_2008.Venta_ProcesarNuevo`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Ventas_Procesar` |
...
| `modify_date` en BD al extraer | `2025-01-02 08:57:19` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_ProcesarNuevo.sql` |
