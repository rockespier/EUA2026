...
# `euroamer_admin_2008.Venta_Validar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Ventas_Validar` |
...
| `modify_date` en BD al extraer | `2023-07-21 01:28:36` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_Validar.sql` |
