...
# `euroamer_admin_2008.Venta_VigenciaValidar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_VigenciaValidar` |
...
| `modify_date` en BD al extraer | `2023-07-31 01:11:09` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_VigenciaValidar.sql` |
