...
# `euroamer_admin_2008.Venta_WEB_Procesar`

| Campo | Valor |
|---|---|
| Dominio | `Venta` |
| Repositorio (.NET) | `VentaRepository.cs` |
| Método(s) que lo invoca | `VentaRepository.Venta_WEB_Procesar` |
...
| `modify_date` en BD al extraer | `2019-02-27 11:14:44` |
| Archivo fuente | `../../sql/euroamer_admin_2008.Venta_WEB_Procesar.sql` |
