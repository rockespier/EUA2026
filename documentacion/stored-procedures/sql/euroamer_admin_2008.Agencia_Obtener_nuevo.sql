-- Objeto: euroamer_admin_2008.Agencia_Obtener_nuevo
-- Creado en BD: 2026-08-11 06:05:17
-- Modificado en BD: 2026-08-11 06:54:55
...
CREATE PROCEDURE [euroamer_admin_2008].[Agencia_Obtener_nuevo]
	@pAGENCIA_Id INT = 0,
...
BEGIN
    ...
    --exec Agencia_Obtener_nuevo 0,0,45,-1,1,'','',''
    --Gestor
