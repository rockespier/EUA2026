-- Objeto: euroamer_admin_2008.Agencia_Procesar_nuevo
-- Creado en BD: 2026-08-10 08:50:06
-- Modificado en BD: 2026-08-19 07:47:19
...
--   @pAGENCIA_VIP int (IN)
--   @pAGENCIA_EJECUTIVOCOBRADOR int (IN)

CREATE PROCEDURE [euroamer_admin_2008].[Agencia_Procesar_nuevo]
	@pAGENCIA_Id INT,
    ...
    @pAGENCIA_VIP INT = 0,
    @pAGENCIA_EJECUTIVOCOBRADOR INT = 0
AS
BEGIN
    ...
    declare @AGENCIA_Nombre_antes VARCHAR(100);
        ...
        ELSE
            BEGIN
                ...
                agenciaVip = @pAGENCIA_VIP,
                agenciaEjecutivoCobrador = @pAGENCIA_EJECUTIVOCOBRADOR
                WHERE agenciaId = @pAGENCIA_Id
                IF @@ROWCOUNT > 0
                    BEGIN
                        set @resultado = 'ok'
