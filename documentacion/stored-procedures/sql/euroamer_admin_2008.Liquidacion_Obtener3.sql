-- Objeto: euroamer_admin_2008.Liquidacion_Obtener3
-- Creado en BD: 2019-07-22 07:51:53
-- Modificado en BD: 2025-10-22 05:30:44
...
CREATE PROCEDURE [euroamer_admin_2008].[Liquidacion_Obtener3]
	@pORIGEN VARCHAR(1),
...
BEGIN
	...
	WHERE	v.ventaProductoId = p.productoId AND 
	        ...
	        (@pLiquidacionPendiente = 0 OR v.ventaCodigoLiquidacion is null) 
