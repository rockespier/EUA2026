-- Objeto: euroamer_admin_2008.VentaGrupal_Procesar_2026
-- Creado en BD: 2026-08-24 08:43:00
-- Modificado en BD: 2026-09-07 01:04:01
...
CREATE PROCEDURE [euroamer_admin_2008].[VentaGrupal_Procesar_2026]
	@pVENTA_GrupalId INT,
...
BEGIN
	...
	DECLARE @vVentaClienteVip INT = 0;
	...
	FETCH cursor_clientes INTO	@vVENTACLIENTE_DocumentoTipo, @vVENTACLIENTE_DocumentoNumero, @vVENTACLIENTE_Nombres, @vVENTACLIENTE_Apellidos,
	                            ...
	                            @vVENTACLIENTE_Nacionalidad,@vVentaClienteVip
