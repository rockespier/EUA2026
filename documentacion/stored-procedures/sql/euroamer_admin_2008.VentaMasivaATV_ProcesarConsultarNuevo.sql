-- Objeto: euroamer_admin_2008.VentaMasivaATV_ProcesarConsultarNuevo
-- Creado en BD: 2019-09-11 06:51:11
...
CREATE PROCEDURE [VentaMasivaATV_ProcesarConsultarNuevo]
	@pVENTA_MasivoId INT
AS
BEGIN
	...
	WHILE @@FETCH_STATUS = 0
		BEGIN
			...
			FETCH	cursor_ventas_masivas INTO	
					...
					@vVENTA_ClienteFechaNacimiento, @vVENTA_ClienteEdad, @vVENTA_ClienteEmail, @vVENTA_ClienteDireccion, @vVENTA_ClienteTelefono, 
					@vVENTA_ClienteDistrito, @vVENTA_ClienteCiudad, @vVENTA_ClientePais, @vVENTA_ContactoNombres, @vVENTA_ContactoDireccion, 
					@vVENTA_ContactoEmail, @vVENTA_ContactoTelefono, @vVENTA_ContactoDistrito, @vVENTA_ContactoPais, @vVENTA_ImporteVenta, @vVENTA_CodigoExterno,@vVENTA_Clientenacionalidad;
		END;
