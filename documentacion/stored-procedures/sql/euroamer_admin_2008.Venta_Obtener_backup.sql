-- Objeto: euroamer_admin_2008.Venta_Obtener_backup
-- Creado en BD: 2026-04-16 02:00:32
-- Modificado en BD: 2026-04-16 02:00:32
...
CREATE PROCEDURE [euroamer_admin_2008].[Venta_Obtener_backup]
	@pORIGEN VARCHAR(1),
...
BEGIN
	...
	SELECT	ventaId,
			...
			(select top 1 CONVERT(VARCHAR(10), cobranzaPagoFecha, 103) from cobranza a, cobranza_detalle b where b.cobranzadetalleVentaId=ventaId and a.cobranzaId = b.cobranzaId order by cobranzamodificadofecha desc) cobranzaPagoFecha,
