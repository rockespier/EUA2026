...
function registrarEventosExportacion() {
    ...
    $("#btnExportPdf").on('click', function (e) {
        ...
        exportarReporteTabla('dtVenta', 'pdf', 'Ventas_por_Promotor', anioFiltro);
    });
    $("#btnExportPdf2").on('click', function (e) {
        e.preventDefault();
        const anioFiltro2 = (($("#mdvenselAnioSearch option:selected").val() || new Date().getFullYear()) - 1);
        exportarReporteTabla('dtVenta2', 'pdf', 'Ventas_por_Promotor', anioFiltro2);
    });
    $("#btnExportAmbosExcel").on('click', function (e) {
        e.preventDefault();
        const anioFiltro = $("#mdvenselAnioSearch option:selected").val() || new Date().getFullYear();
        exportarReporteAmbosCuadros('dtVenta', 'dtVenta2', 'excel', 'Ventas_por_Promotor', anioFiltro, anioFiltro - 1);
    });
    $("#btnExportAmbosPdf").on('click', function (e) {
        e.preventDefault();
        const anioFiltro = $("#mdvenselAnioSearch option:selected").val() || new Date().getFullYear();
        exportarReporteAmbosCuadros('dtVenta', 'dtVenta2', 'pdf', 'Ventas_por_Promotor', anioFiltro, anioFiltro - 1);
    });
...
async function getVentasPromotor(int_pAnio, int_pPaisId, int_TipoReporte, int_pPromotorId) {
    const urlApiFecht = menuUrlApi + "Reportes/VentasPromotorObtener";
    const urlParametro = "?int_pAnio=" + int_pAnio + "&int_pPaisId=" + int_pPaisId + "&int_TipoReporte=" + int_TipoReporte + "&int_pPromotorId=" + int_pPromotorId;
