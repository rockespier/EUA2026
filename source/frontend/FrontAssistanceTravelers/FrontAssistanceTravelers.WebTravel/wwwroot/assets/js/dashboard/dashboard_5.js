...
const radialchart_5_1 = document.querySelector('#radial-facebook');
if (radialchart_5_1) {
    var radialprogessChart_5_1 = new ApexCharts(radialchart_5_1, radialCommonOption(radial_5_1));
    radialprogessChart_5_1.render();
}
...
const radialchart_5_2 = document.querySelector('#radial-instagram');
if (radialchart_5_2) {
    var radialprogessChart_5_2 = new ApexCharts(radialchart_5_2, radialCommonOption(radial_5_2));
    radialprogessChart_5_2.render();
}
...
const radialchart_5_3 = document.querySelector('#radial-twitter');
if (radialchart_5_3) {
    var radialprogessChart_5_3 = new ApexCharts(radialchart_5_3, radialCommonOption(radial_5_3));
    radialprogessChart_5_3.render();
}
