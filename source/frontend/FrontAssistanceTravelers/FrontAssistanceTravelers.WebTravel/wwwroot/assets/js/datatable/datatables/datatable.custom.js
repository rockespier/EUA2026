$(document).ready(function() {
    ...
    $('#basic-1').DataTable({
        ...
        "language": {
            ...
            "bLengthChange": false, //no mostrar el combo de registros por página
            "bInfo": false,
            "pageLength": 10,
            "filter": true,
    ...
    function format ( d ) {
        return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">'+
            ...
            '<td>' + d.stock + '</td>' +
            '<td>' + d.solicitado + '</td>' +
            '<td><a href="#" class="btn btn-primary mb-3"><span class="glyphicon glyphicon-plus"></span>Entregar</a>' +
            '</tr>' +            
            '</table>';
    }
    //chield row multiple data table start here
    var ct = $('#API-chield-row').DataTable({
        "ajax": "../assets/ajax/repuestos.txt",
        "columns": [{
