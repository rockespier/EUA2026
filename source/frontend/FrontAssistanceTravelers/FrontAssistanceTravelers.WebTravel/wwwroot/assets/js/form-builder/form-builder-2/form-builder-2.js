$(document).ready(function() {
    ...
    $("#n-columns").on("change", function() {
        var v = $(this).val();
        if(v==="1") {
            var $col = $('.form-body .col-6-12').toggle(true);
            $('.form-body .col-6-6 .draggable').each(function(i, el) {
                $(this).remove().appendTo($col);
            })
            $('.form-body .col-6-6').toggle(false);
        } else {
            var $col = $('.form-body .col-6-6').toggle(true);
            $(".form-body .col-6-12 .draggable").each(function(i, el) {
                $(this).remove().appendTo(i % 2 ? $col[1] : $col[0]);
            });
            $('.form-body .col-6-12').toggle(false);
        }
    });
